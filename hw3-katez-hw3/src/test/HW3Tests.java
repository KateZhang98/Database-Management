...
//		System.out.println(root.getSearchKey());
...
//		bt.printTree(bt.getRoot());
	...
	public void testDelete() {
		...
		bt.insert(new Entry(new IntField(3), 0));
		bt.insert(new Entry(new IntField(10), 0));
//		System.out.println(((InnerNode)bt.getRoot()).getKeys().size());
//		System.out.println(((InnerNode)bt.getRoot()).getKeys().get(0));
		...
		InnerNode left = (InnerNode) ((InnerNode)bt.getRoot()).getChildren().get(0);
		for(Node nn: left.getChildren()) {
			System.out.println("Size: "+ ((LeafNode) nn).getEntries().size());
			for(Entry ff: ((LeafNode)nn).getEntries()) {
				System.out.println("field in ff " + ff.getField());
			}
		}
		System.out.println("==========Start deleting 4=======================");
		bt.delete(new Entry(new IntField(4), 0));
		System.out.println("===========Delete 4 completed================");
		
//		InnerNode tempRoot = (InnerNode) bt.getRoot();
//		InnerNode tempL = (InnerNode) tempRoot.getChildren().get(0);
//		for(Field tt: tempL.getKeys()) {
//			System.out.println("Keys in the left after delete 4 "+tt);
//		}
		...
		ArrayList<Node> cl = l.getChildren();
		for(Field key: kl) {
			System.out.println("Keys in the left node "+ key);
		}
	...
	public void testDeleteLevelToRoot() {
		...
		bt.insert(new Entry(new IntField(4), 0));
		bt.insert(new Entry(new IntField(1), 0));
//		System.out.println("Delete to root test=============================================");
	
		bt.delete(new Entry(new IntField(9), 0));
//		System.out.println("Delete to root test done ====================================================================");
//		for(Entry e: ((LeafNode) bt.getRoot()).getEntries()) {
//			System.out.println("entries in the node: "+ e.getField());
//		}
	...
	public void testSimpleLeafSplit() {
		// create a new B+ tree
		BPlusTree bt = new BPlusTree(3, 2);
//		System.out.println("simple Leaf Split test----------------------------------------- ");
		bt.insert(new Entry(new IntField(3), 0)); 
		bt.insert(new Entry(new IntField(4), 0));
		bt.insert(new Entry(new IntField(5), 0));
//		System.out.println("Inserting 2===================");
		bt.insert(new Entry(new IntField(2), 0));
//		System.out.println("Inserting 2 complete-------------------------------------");
	...
	public void testRemoveLevel() {
		...
		//                   /   |   \
		//               [2,4] [7, ] [12, ]
//		System.out.println("Remove level test=================================");
		bt.delete(new Entry(new IntField(9), 0));
//		System.out.println("Remove level test complete=================================");
		Node root = bt.getRoot();
		assertTrue(root.isLeafNode() == false);
...
//		System.out.println("Start of search 1-------------------------------------------------------");
