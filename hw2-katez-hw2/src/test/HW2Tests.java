...
//		System.out.println("start tuples" + ahf.getAllTuples()+"end tuples");
//		System.out.println(ar.getTuples().size()+"before select");
		ar = ar.select(0, RelationalOperator.EQ, new IntField(530));
//		System.out.println(ar.getTuples().size()+"after select");
	...
	public void testProjectRemoveAllColumnsR() {
		...
		ArrayList<Integer> c = new ArrayList<Integer>();
		ar = ar.project(c);
		System.out.println("Remove all columns test: " + ar.getTuples().size());
...
//		System.out.println(ar.getTuples().size());
	...
	public void testRenameNullR() throws Exception {
		...
		ar = ar.rename(f, n);
		System.out.println("test print "+ ar.getTuples().size());
		assertTrue("Rename should not remove any tuples", ar.getTuples().size() == 8);
	...
	public void testAggregateR() {
		...
		ArrayList<Integer> c = new ArrayList<Integer>();
		c.add(1);
		System.out.println("agg test "+ar+"----------------");
		ar = ar.project(c);
	...
	public void testJoinOnStringFieldsQ() {
		...
		System.out.println("resulting table: "+ t.getDesc().nameToId("s1"));
		System.out.println("resulting table: "+ t.getField(2).getType());
...
//		System.out.println("Aggregate test----");
	...
	public void testMultiJoinQuery() {
		...
		System.out.println("MultiJoin Query");
		Relation r = q.execute();
